...
class TestDocumentTablesAPI(unittest.TestCase):
    ...
    @patch('search_service.api.documents.TableSchema')
    @patch('search_service.api.documents.reqparse.RequestParser')
    @patch('search_service.api.documents.get_proxy_client')
...
class DocumentUsersAPITest(unittest.TestCase):
    def setUp(self) -> None:
        self.app = create_app(config_module_class='search_service.config.Config')
        self.app_context = self.app.app_context()
        self.app_context.push()
    ...
    @patch('search_service.api.documents.UserSchema')
    @patch('search_service.api.documents.reqparse.RequestParser')
    @patch('search_service.api.documents.get_proxy_client')
